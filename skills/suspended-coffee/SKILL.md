...
**Part 4 — update state.** Set `last_coffee_at: <ISO timestamp>` in `~/.claude/plugins/suspended-coffee/state.json`.
...
Located at `~/.claude/plugins/suspended-coffee/state.json`:
